...
// @Override
// public Page<EventListItemDTO> searchEvents(String keyword, int page, int
// size) {
...
// // 查詢圖片
// List<EventImageVO> images =
// eventImageRepository.findByEvent_EventId(eventId);

// // 查詢票種
// List<TicketVO> tickets = ticketRepository.findByEvent_EventId(eventId);

// // 查詢票價範圍
// Integer minPrice = ticketRepository.findMinPriceByEventId(eventId);
// Integer maxPrice = ticketRepository.findMaxPriceByEventId(eventId);
...
// eventFavRepository.existsByMember_MemberIdAndEvent_EventId(memberId,
// eventId);
...
// @Override
// public List<EventListItemDTO> getOrganizerEvents(Integer organizerId, int
// limit) {
...
// List<EventFavVO> favorites =
// eventFavRepository.findByMember_MemberId(memberId);
...
// dto.setCoverImageUrl(coverImage.map(EventImageVO::getImageUrl).orElse(null));

// // 查詢最低票價
// Integer minPrice =
// ticketRepository.findMinPriceByEventId(event.getEventId());
// dto.setMinPrice(minPrice);

// // 查詢收藏數量
// Long favoriteCount =
// eventFavRepository.countByEvent_EventId(event.getEventId());
// dto.setFavoriteCount(favoriteCount);
