...
//    	List<ProdVO> list = repository.findAll();
//		for (ProdVO allProd : list) {
//			System.out.print(allProd.getProdId() + ",");
//			System.out.print(allProd.getOrganizerVO().getOrganizerId() + ",");
//			System.out.print(allProd.getProdSortVO().getSortId() + ",");
//			System.out.print(allProd.getEmpVO().getEmpId() + ",");
//			System.out.print(allProd.getProdName() + ",");
//			System.out.print(allProd.getProdPrice() + ",");
//			System.out.print(allProd.getProdStock() + ",");
//			System.out.print(allProd.getCreatedAt() + ",");
//			System.out.print(allProd.getUpdatedAt() + ",");
//			System.out.print(allProd.getProdStatus() + ",");
//			System.out.print(allProd.getReviewStatus() + ",");
//
//			System.out.println();
//		}
