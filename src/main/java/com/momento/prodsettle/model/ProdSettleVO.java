...
public class ProdSettleVO {
	...
	// 新增一對多關聯
    @OneToMany(mappedBy = "prodSettleId", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<ProdSettleDetailVO> prodSettles = new ArrayList<>();
	
	public List<ProdSettleDetailVO> getProdSettles() {
		return prodSettles;
	}

	public void setProdSettles(List<ProdSettleDetailVO> prodSettles) {
		this.prodSettles = prodSettles;
	}
